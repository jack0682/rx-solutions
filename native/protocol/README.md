...
The isolated docker/ProtocolValidation.Dockerfile target is used for cross-language tests without device mounts or network. It is not a product image and does not replace the mandatory ROBOTIS/ROS dependency build.
